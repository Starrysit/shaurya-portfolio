...
const PROJECTS = [
  {
    ...
    github: "https://github.com/shaurya-sharma",
    live: null,
    featured: true,
    accentColor: "#7c3aed",
  },
  {
    ...
    description:
      "Full-stack system for managing library operations — book issuance, member management, return tracking, and an admin dashboard. Built with Spring Boot REST APIs and a React frontend backed by MySQL.",
    image: "/project-library.png",
    tags: ["Spring Boot", "React", "MySQL", "REST API", "Java", "JPA"],
    tagColors: {
      "Spring Boot": "#10b981",
      React: "#06b6d4",
      MySQL: "#3b82f6",
